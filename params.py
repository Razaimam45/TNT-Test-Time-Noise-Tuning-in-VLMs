...
def get_args_rl(description='Test Time Reinforcement Learning With CLIP Reward'):
    """config of program"""
    
    default_data = '/home/raza.imam/Documents/TPT/datasets'
    default_test_sets = 'Flower102/DTD' #cifar10c #'A/V/R/K/C' #Flower102/DTD/Pets/UCF101/Caltech101/Aircraft/eurosat/Cars/Food101/SUN397
    default_gpu = 2
    default_arch = 'ViT-B/16'
    default_tpt = True
    # default_coop_weight='/home/raza.imam/Documents/RLCF/RLCF/pretrained/vit_b16_ep50_16shots/nctx4_cscFalse_ctpend/seed2/prompt_learner/model.pth.tar-50'
    default_coop_weight='/home/raza.imam/Documents/RLCF/RLCF/pretrained/rn50_ep50_16shots/nctx4_cscFalse_ctpend/seed2/prompt_learner/model.pth.tar-50'
    # default_coop_weight=None
    default_lr = 7e-3
    default_ctx_init = 'a_photo_of_a'
    default_tta_steps = 1
    default_kd_loss = 'KD'
    default_min_entropy_reg = 1
    default_noise = 0
    default_batch_size = 64
    
    # Config for CLIP reward
    default_reward_arch='ViT-B/16' # 'ViT-B/16', 'ViT-L/14'
    default_reward_amplify=0
    default_reward_process=1
    default_process_batch=0
    default_sample_k=3

    parser = argparse.ArgumentParser(description=description)

    parser = argparse.ArgumentParser(description='Test-time Prompt Tuning')
    parser.add_argument('data', metavar='DIR', nargs="?", default=default_data, help='path to dataset root')
    ...
    parser.add_argument('--batch_size', default=default_batch_size, type=int, metavar='N')
    ...
    parser.add_argument('--gpu', default=default_gpu, type=int,
                        help='GPU id to use.')
    parser.add_argument('--tpt', action='store_true', default=default_tpt, help='run test-time prompt tuning')
    ...
    parser.add_argument('--load', default=default_coop_weight, type=none_or_str, help='path to a pre-trained coop/cocoop')
    ...
    # RL config
    parser.add_argument('--sample_k', type=int, default=default_sample_k)
    parser.add_argument('--multiple_reward_models', type=int, default=0)
    parser.add_argument('--reward_arch', type=str, default=default_reward_arch)
    parser.add_argument('--reward_process', type=int, default=default_reward_process,
                         help='If true, process rewards (raw CLIPScore), for example, baseline subtraction')
    parser.add_argument('--process_batch', type=int, default=default_process_batch,
                         help='If true, process rewards through the whole batch (augmentations from a single images)')
    parser.add_argument('--reward_amplify', type=int, default=default_reward_amplify)
    ...
    parser.add_argument('--min_entropy_reg', type=int, default=default_min_entropy_reg)
    ...
    # For KD loss choice
    parser.add_argument('--kd_loss', type=str, default=default_kd_loss, choices=["KD", "DKD", "ATKD"],
                            help="choices of KD loss types")
    
    parser.add_argument('--noise', type=int, default=default_noise, help='If true, add noise to the rewards')
...
def get_args_kd(description='Test Time Reinforcement Learning With CLIP Reward'):
    """config of program"""
    
    default_data = '/home/raza.imam/Documents/TPT/datasets'
    default_test_sets = 'A/V/Flower102/Aircraft' #'A/V/R/K' #Flower102/DTD/Pets/UCF101/Caltech101/Aircraft/eurosat/Cars/Food101/SUN397
    default_gpu = 3
    default_arch = 'ViT-B/16'
    default_tpt = True
    default_coop_weight='/home/raza.imam/Documents/RLCF/RLCF/pretrained/vit_b16_ep50_16shots/nctx4_cscFalse_ctpend/seed2/prompt_learner/model.pth.tar-50'
    ...
    default_ctx_init = 'a_photo_of_a'
    default_tta_steps = 1
    default_kd_loss = 'FD_CLIP'
    default_min_entropy_reg = 1
    
    # Config for CLIP reward
    default_reward_arch='ViT-B/16'
    default_reward_amplify=0
    default_reward_process=1
    default_process_batch=0
    default_sample_k=3
